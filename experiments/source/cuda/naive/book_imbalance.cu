...
__global__ void book_imbalance_kernel(const float* bid, const float* ask, float epsilon, float* out,
                                      std::int64_t n) {
...
extern "C" int book_imbalance_run(float epsilon, const float* bid, const float* ask, float* out, std::int64_t n) {
